package com.ltsllc.mirada.utilities;
...
public class Example {
     ...
     */
    X509Certificate generateCertificateOriginal(String dn, KeyPair pair, int days, String algorithm)
    ...
    public static void main (String[] argv) throws Exception {
        ...
        String distinguishedName = "uid=john.doe,ou=People,dc=example,dc=com";
